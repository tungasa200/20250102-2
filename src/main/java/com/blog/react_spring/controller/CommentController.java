...
import com.blog.react_spring.dto.request.comment.CommentDto;
import com.blog.react_spring.dto.response.comment.ResCommentDto;
import com.blog.react_spring.entity.Member;
import com.blog.react_spring.service.CommentService;
...
public class CommentController {
    ...
    @GetMapping("/list")
    public ResponseEntity<Page> commentList(@PathVariable Long boardId, @PageableDefault(size = 5, sort = "id", direction = Sort.Direction.DESC) Pageable pageable){
